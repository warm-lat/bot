    ...
    async def sendlogs(
        ...
        try:  
            ...
            try:
                ...
                #     posthog_selfhost.group_identify(
                #         group_type="guild",
                #         group_key=str(author.guild.id),
                #         properties={
                #             "last_moderation_action": action,
                #             "total_cases": case,
                ...
                #     if processed_action['should_dm'] and settings.get('dm_enabled'):
                #         try:
                #             properties["dm_success"] = True
                #             posthog_selfhost.capture(
                #                 distinct_id=str(victim.id),
                #                 event="moderation_dm_received",
                #                 properties=properties
                #             )
                #         except:
                #             pass

                #     posthog_selfhost.flush()
